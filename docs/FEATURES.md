...
| `mobile` | Mobile app static analysis (APK/IPA manifest & config checks for authorized lab/defense use only; dynamic loadout design in `plans/dynamic-mobile-testing-loadout-design-plan.md`) | zip, plist (optional under feature) |
