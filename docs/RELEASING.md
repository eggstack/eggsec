...
Current validated order (dependencies before dependents; regenerate with the
command above after any manifest change — last refreshed for Phase B,
2026-09-16):
...
16. `eggsec-daemon` (depends on `eggsec-runtime`, `eggsec`, `eggsec-daemon-protocol`)
