...
| `nse` | none (runtime OpenSSL is vendored) | `cargo test -p eggsec --features nse,cli --test nse_tests --test nse_integration_tests` (runtime tests: [eggsec-nse CI](https://github.com/eggstack/eggsec-nse/actions)) |
