...
See "Recommendations", "Future", "Data Model", and `dynamic.rs` for details.
...
```
See "Policy Note" (Intrusive for real Frida). Phase 2 closed; Phase 3a executed.
