...
- `correlate_findings` handles Frida findings (crypto+static-secret, api+traffic/network, bypass+debug-perm, secret-extract+static) and populates static_correlation.
