...
async fn fingerprint_port(
    ...
    let probes_to_try: &[(&str, &[u8], &str)] = match port {
        ...
        22 | 2222 => &[("SSH", b"", "SSH")],
        21 | 2121 => &[("FTP", b"", "220")],
        25 | 587 | 465 | 2525 => &[("SMTP", b"EHLO test\r\n", "220|250|EHLO")],
        3306 | 3307 | 33060 => &[("MySQL", b"\x00\x00\x00\x00\x0a\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", "\\x00\\x00\\xff")],
        5432 | 5433 => &[("PostgreSQL", b"\x00\x00\x00\x08\x04\xd2\x16\x2f", "\\x00\\x00\\x00")],
        6379 | 6380 => &[("Redis", b"PING\r\n", "+PONG")],
        27017 | 27018 | 27019 | 28017 => &[("MongoDB", b"\x3a\x00\x00\x00\xa8\x3d\x00\x00\x00\x00\x00\x00\xd4\x07\x00\x00\x00\x00\x00\x00admin.$cmd\x00\x00\x00\x00\x00\xff\xff\xff\xff\x1b\x00\x00\x00\x01ismaster\x00\x00\x00\x00\x00\x00\x00\xf0\x3f\x00", "ismaster")],
        11211 | 11212 => &[("Memcached", b"stats\r\n", "STAT|END")],
        3389 => &[("RDP", b"\x03\x00\x00\x13\x0e\xe0\x00\x00\x00\x00\x00\x01\x00\x08\x00\x0b\x00\x00\x00", "\\x03\\x00")],
        5900..=5903 => &[("VNC", b"", "RFB")],
        23 => &[("Telnet", b"", "login:|telnet")],
        ...
        873 => &[("Rsyncd", b"", "@RSYNCD:")],
        11210 => &[("Couchbase", b"\x80\x00\x00\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", "\\x80")],
        1194 => &[("OpenVPN", b"\x00\x01\x00\x00\x00\x00\x00", "\\x00\\x01\\x00\\x00")],
        5985 | 5986 => &[("WinRM", b"<?xml version=\"1.0\"?><s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\"><s:Body/></s:Envelope>", "soap")],
        61613 | 61614 => &[("ActiveMQ", b"CONNECT\r\n", "ActiveMQ")],
        8091 | 8092 => &[("MinIO", b"GET /minio/health/live HTTP/1.0\r\n\r\n", "\"ready\"")],
        5984 => &[("CouchDB", b"GET / HTTP/1.0\r\n\r\n", "CouchDB")],
        8500 => &[("Consul", b"GET /v1/agent/self HTTP/1.0\r\nHost: localhost\r\n\r\n", "Consul")],
        2375 | 2376 => &[("Docker", b"GET /version HTTP/1.0\r\nHost: localhost\r\n\r\n", "ApiVersion|Docker")],
        4222 | 8222 | 9222 | 6222 => &[("Nats", b"INFO\r\n", "INFO")],
        2379 | 2380 => &[("Etcd", b"GET /version HTTP/1.0\r\nHost: localhost\r\n\r\n", "etcdserver")],
        4444 => &[("gRPC", b"\x00\x00\x00\x00\x10\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", "\\x00\\x00\\x00\\x00\\x10")],
        5555 => &[("ZeroMQ", b"", "READY|DATA")],
        4150..=4152 => &[("NSQ", b"  V2", "\\x20\\x56\\x32")],
        5666 => &[("Nagios", b"", "nagios|NRPE")],
        502 | 102 | 44818 => &[("Modbus/ICS", b"\x00\x00\x00\x05\x00\x00\x00\x00\x00\x39\x00\x03\x00\x00\x00\x05", "\\x00\\x00")],
        47808 => &[("BACnet", b"\x81\x0a\x00\x11\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", "\\x81")],
        _ => PROBES,
    };
