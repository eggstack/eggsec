...
use slapper::config::{FuzzProfile, ScanConfig, SlapperConfig};
use slapper::utils::parsing::parse_ports;
...
#[test]
fn test_slapper_config_structure() {
...
fn test_scope_rule_basic() {
    ...
    assert!(rule.matches(&slapper::config::TargetScope {
