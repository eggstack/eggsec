fn main() {
    #[cfg(feature = "grpc-api")]
    {
        ...
        let generated_path = std::path::Path::new(&out_dir).join("slapper.tool.v1.rs");
        let reference_path = std::path::Path::new("src/generated/slapper.tool.v1.rs");
        ...
        if generated_path.exists() && reference_path.exists() {
            ...
            if generated != reference {
                println!(
                    "cargo::warning=Reference copy src/generated/slapper.tool.v1.rs is out of sync with generated code. Run: cp {} src/generated/slapper.tool.v1.rs",
