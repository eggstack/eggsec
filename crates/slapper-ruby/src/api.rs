...
#[cfg(feature = "ruby-plugins")]
fn get_blocking_handle() -> &'static tokio::runtime::Handle {
...
#[cfg(feature = "ruby-plugins")]
fn get_blocking_handle() -> tokio::runtime::Handle {
    get_blocking_runtime().handle().clone()
}
