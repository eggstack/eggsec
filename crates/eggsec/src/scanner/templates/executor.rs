...
impl TemplateExecutor {
    ...
    async fn send_request(
        ...
        let response = req_builder
            ...
            .send()
            .await
            .map_err(|e| EggsecError::Network(format!("Template request failed: {}", e)))?;
        ...
        let body = response
            .text()
            .await
            .map_err(|e| EggsecError::Network(format!("Failed to read response body: {}", e)))?;
    ...
    pub async fn execute_dns_template(
        ...
        let matched = if let Some(super::models::Matcher::Dns(dns)) = dns_matcher {
            ...
            .build()
            .map_err(|e| EggsecError::Network(format!("DNS resolver init failed: {}", e)))?;
            ...
            let response = resolver
                ...
                .await
                .map_err(|e| EggsecError::Network(format!("DNS query failed: {}", e)))?;
