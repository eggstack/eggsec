...
Examples:
  ...
  eggsec load https://api.example.com/endpoint -n 500 -c 20 -m POST -d '{\"query\": \"test\"}'
  eggsec load https://example.com -n 100 --json
  eggsec load https://example.com -n 200 -c 10 --proxy http://127.0.0.1:8080";
...
Examples:
  ...
  eggsec recon example.com --concurrency 20
  eggsec recon example.com --json";
...
Examples:
  ...
  eggsec graphql https://api.example.com/graphql --json";
...
Examples:
  eggsec oauth https://oauth.example.com/authorize
  eggsec oauth https://oauth.example.com --redirect-test
  eggsec oauth https://oauth.example.com --scope-test
  eggsec oauth https://oauth.example.com --json";
