...
Examples:
  eggsec vuln score CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H
  eggsec vuln exploitability CVE-2021-44228
  eggsec vuln prioritize --severity critical --cvss 9.8
  eggsec vuln triage --title 'SQL Injection' --severity high
  eggsec vuln remediate --severity critical";
