...
impl SearchTool {
    ...
    async fn search_searxng(
    ...
    ) -> Result<Vec<SearchResult>, crate::error::EggsecError> {
        let mut url = format!(
            "{}/search?q={}",
            self.searxng_url,
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| EggsecError::Network(format!("SearXNG request failed: {}", e)))?;
        ...
        let results: serde_json::Value = response
            .json()
            .await
            .map_err(|e| EggsecError::Parse(format!("Failed to parse SearXNG response: {}", e)))?;
    ...
    async fn search_osv(
        &self,
        query: &str,
    ) -> Result<Vec<CveSearchResult>, crate::error::EggsecError> {
        ...
        let response = client
            ...
            .send()
            .await
            .map_err(|e| EggsecError::Network(format!("OSV request failed: {}", e)))?;
        ...
        let results: serde_json::Value = response
            .json()
            .await
            .map_err(|e| EggsecError::Parse(format!("Failed to parse OSV response: {}", e)))?;
    ...
    async fn search_nvd(
        ...
        let response = client
            ...
            .send()
            .await
            .map_err(|e| EggsecError::Network(format!("NVD request failed: {}", e)))?;
        ...
        let results: serde_json::Value = response
            .json()
            .await
            .map_err(|e| EggsecError::Parse(format!("Failed to parse NVD response: {}", e)))?;
