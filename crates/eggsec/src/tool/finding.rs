...
//! in `eggsec-tool-core`. This module re-exports them and adds `From` impls
//! that depend on scanner/fuzzer/recon types from the main `eggsec` crate.

pub use eggsec_tool_core::finding::{Finding, FindingType, ResponseSeverity};
