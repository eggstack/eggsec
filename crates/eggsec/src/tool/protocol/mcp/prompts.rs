...
pub fn get_coding_agent_prompts() -> Vec<McpPrompt> {
    vec![
        ...
        McpPrompt {
            ...
            description: "Help interpret Eggsec evidence and map to patch planning".to_string(),
            arguments: vec![
                PromptArgument {
                    name: "finding".to_string(),
            ...
            template: "Interpret the following Eggsec finding and map it to a code fix plan:\n\nFinding: {{finding}}\nTarget: {{target}}"
                .to_string(),
        },
    ]
}
