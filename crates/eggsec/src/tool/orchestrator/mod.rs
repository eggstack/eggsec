...
impl Orchestrator {
    ...
    ) -> Result<ExecutionResult, EggsecError> {
    ...
    fn resolve_stage_order(&self, plan: &ExecutionPlan) -> Result<Vec<String>, EggsecError> {
    ...
    async fn execute_stage(
        ...
        let stage = plan
            ...
            .ok_or_else(|| EggsecError::Config(format!("Stage '{}' not found", stage_name)))?;
    ...
    fn process_tool_result(
        &self,
        tool: ToolExecution,
        result: Result<ToolResponse, EggsecError>,
        duration_ms: u64,
    ) -> StageToolResult {
        match result {
