...
// ---------------------------------------------------------------------------
// Phase D WS6: target and catalog live in cohesive modules.
// Re-exported here so `crate::config::policy::{...}` remains a stable facade.
// ---------------------------------------------------------------------------

pub use super::policy_catalog::{
