...
// Phase D WS7: address classification and host resolution live in cohesive
// modules. Re-exported here so `crate::config::scope::{AddressClass, ...}`
// remains a stable facade.
pub use super::scope_address::{classify_address, is_private_ip, AddressClass};
pub use super::scope_resolver::{default_resolver, HostResolver, ResolutionResult, SystemResolver};
