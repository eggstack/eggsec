//! Security fuzzing engine with 40 payload types
//!
//! This module provides a comprehensive fuzzing engine for discovering security vulnerabilities
//! in web applications. It supports 40 different payload types including SQL injection, XSS,
...
//! - [`PayloadType`] - Enumeration of all supported payload types (40 types)
...
//!
//! ```rust,no_run
//! use eggsec::fuzzer::{FuzzEngine, PayloadType, get_payloads, Severity};
//!
...
//!
//! ```rust,no_run
//! use eggsec::fuzzer::generate_mutations;
//!
//! let original = "' OR 1=1--";
