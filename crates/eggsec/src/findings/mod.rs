...
//! for representing security findings across all Eggsec modules.
//!
//! ## Design
//!
...
pub struct FindingSource {
    /// Tool name (e.g. "eggsec", "nmap", "custom-plugin").
    pub tool: String,
...
///
/// This is the unified schema that all Eggsec modules should eventually produce.
