...
// regeneration. Edit the source proto definition at:
//   crates/eggsec/src/tool/protocol/grpc.proto
                ...
                "/eggsec.tool.v1.ToolService/GetCapabilities" => {
                    ...
                    for GetCapabilitiesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ToolService>::get_capabilities(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
