...
mod tests {
    use eggsec::agent::{Priority, TargetConfig, TargetPortfolio};
    ...
    fn test_portfolio_add_scan_record() {
        ...
        let record = eggsec::agent::ScanRecord {
    ...
    fn test_add_target_preserves_existing_targets() {
        ...
        let base_dir = directories::ProjectDirs::from("com", "eggsec", "eggsec")
            .map(|d| d.config_dir().to_path_buf())
            .unwrap_or_else(|| PathBuf::from("/home/sugarwookie/.config/eggsec"));
