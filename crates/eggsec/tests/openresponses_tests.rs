...
mod tests {
    ...
    fn test_responses_request_type() {
        use eggsec::tool::protocol::openresponses::types::{Input, ResponsesRequest};
    ...
    fn test_tool_info_type_exists() {
        use eggsec::tool::{ToolCapability, ToolCategory, ToolInfo};
    ...
    fn test_openresponses_router_function() {
        use eggsec::tool::protocol::openresponses;
    ...
    fn test_ai_finding_serialization() {
        use eggsec::tool::protocol::openresponses::types::AiFinding;
    ...
    fn test_output_item_message_variant() {
        use eggsec::tool::protocol::openresponses::types::OutputItem;
    ...
    fn test_output_item_finding_variant() {
        use eggsec::tool::protocol::openresponses::types::{AiFinding, OutputItem};

        let item = OutputItem::Finding {
            item_type: "eggsec:security_finding".into(),
            id: "finding-1".into(),
            finding: AiFinding {
        ...
        let json = serde_json::to_string(&item).unwrap();
        assert!(json.contains("eggsec:security_finding"));
    }

    #[test]
    fn test_responses_response_type() {
        use eggsec::tool::protocol::openresponses::types::{OutputItem, ResponsesResponse};
    ...
    fn test_input_text_variant() {
        use eggsec::tool::protocol::openresponses::types::Input;
    ...
    fn test_input_items_variant() {
        use eggsec::tool::protocol::openresponses::types::{Input, InputItem};
    ...
    fn test_function_tool_type() {
        use eggsec::tool::protocol::openresponses::types::{FunctionTool, ToolChoice};
    ...
    fn test_error_response_type() {
        use eggsec::tool::protocol::openresponses::types::ErrorResponse;
    ...
    #[test]
    fn test_usage_type() {
        use eggsec::tool::protocol::openresponses::types::Usage;
