...
mod tests {
    ...
    fn test_openai_chat_completion_request() {
        use eggsec::tool::protocol::openai::types::{ChatCompletionRequest, ChatMessage};
    ...
    fn test_openai_chat_completion_response() {
        use eggsec::tool::protocol::openai::types::{ChatCompletionResponse, ChatMessage, Choice};
    ...
    fn test_openai_tool_definition_builder() {
        use eggsec::tool::protocol::openai::types::ToolDefinition;
    ...
    fn test_function_call_type() {
        use eggsec::tool::protocol::openai::types::FunctionCall;
    ...
    fn test_tool_call_type() {
        use eggsec::tool::protocol::openai::types::{FunctionCall, ToolCall};
    ...
    #[test]
    fn test_usage_type() {
        use eggsec::tool::protocol::openai::types::Usage;
