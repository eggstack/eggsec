...
use crate::policy::{Capability, IntendedUse, OperationDescriptor, OperationMode, OperationRisk};
use crate::target::{
...
mod operation_metadata_tests {
    use super::*;
    use crate::baseline_allowed_capability;
    ...
    fn every_registered_tool_has_operation_metadata() {
        ...
        // Feature-gated tools: metadata entries are unconditional in this
        // crate (feature availability is a caller-supplied evaluation input,
        // not a compile-time gate on the catalog), so always check them.
        assert!(
