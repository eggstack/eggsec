...
//!
//! Stable facade: `decision.rs` re-exports everything here.

use crate::{ExecutionProfile, ExecutionSurface, OperationDescriptor, PolicyDecision};

/// Proof that an operation has passed enforcement evaluation.
///
/// This token is produced exclusively by [`crate::EnforcementContext::approve`] or
/// [`crate::EnforcementContext::approve_manual`]. Strict programmatic surfaces
...
mod tests {
    use super::*;
    use crate::{
        EnabledFeatures, EnforcementContext, ExecutionPolicy, LoadedScope, OperationMode,
        OperationRisk,
    };
    ...
    fn loopback_facts() -> crate::TargetScope {
        crate::TargetScope::for_ip("127.0.0.1".parse().unwrap())
    }
