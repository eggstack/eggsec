...
use slapper::wireless::WirelessScanResult;
            ...
            self.results_view.add_line(Line::from(vec![
                ...
                Span::styled(
                    ...
                    Style::default().fg(match network.security_type {
                        slapper::wireless::SecurityType::Open => tc!(error),
                        slapper::wireless::SecurityType::WEP => tc!(error),
                        slapper::wireless::SecurityType::WPA => tc!(warning),
                        _ => tc!(success),
                    }),
                ),
