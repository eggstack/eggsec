...
use slapper::browser::{BrowserConfig, BrowserReport};
...
impl BrowserTab {
    pub fn new() -> Self {
        let inputs = InputGroup::new().add(InputField::new("Target URL")).add(
            InputField::new("Timeout (ms)")
                .with_value(&slapper_core::constants::DEFAULT_BROWSER_TIMEOUT_MS.to_string()),
        );
    ...
    pub fn timeout_ms(&self) -> u64 {
        self.inputs
            ...
            .unwrap_or(slapper_core::constants::DEFAULT_BROWSER_TIMEOUT_MS)
    }
