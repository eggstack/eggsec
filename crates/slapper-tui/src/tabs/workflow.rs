...
use slapper::workflow::finding::Finding;
use slapper::workflow::finding::FindingStatus;
use slapper::workflow::sla::calculate_sla;
...
impl WorkflowTab {
    ...
    pub fn selected_severity(&self) -> slapper::types::Severity {
        match self.severity_selector.selected {
            0 => slapper::types::Severity::Critical,
            1 => slapper::types::Severity::High,
            2 => slapper::types::Severity::Medium,
            3 => slapper::types::Severity::Low,
            _ => slapper::types::Severity::Info,
        }
    }
