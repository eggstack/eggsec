...
pub async fn run_fuzz(
    ...
    use slapper::cli::{CommonHttpArgs, FuzzArgs, FuzzMode};
...
pub async fn run_waf(
    ...
    if bypass_mode {
        ...
        use slapper::waf::{get_auto_profile, BypassEngine, TestType};
...
pub async fn run_waf_stress(
    ...
    use slapper::cli::WafStressArgs;
    use slapper::fuzzer::run_waf_stress as fuzzer_run_waf_stress;
