...
pub async fn run_pipeline(
    ...
    use slapper::cli::{CommonHttpArgs, ScanArgs};
    use slapper::pipeline::Pipeline;
    ...
    let args = ScanArgs {
        ...
        format: output_format.parse::<slapper::cli::OutputFormat>().ok(),
        web_types: None,
...
pub async fn run_recon(
    ...
    use slapper::recon::run_full_recon;
    ...
    let max_retries = slapper_core::constants::DEFAULT_MAX_RETRIES;
