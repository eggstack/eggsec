...
pub enum TaskResult {
    LoadTest(slapper::loadtest::metrics::LoadTestResults),
    #[cfg(feature = "stress-testing")]
    StressTest {
        target: String,
        stats: slapper::stress::StressStats,
    },
    PortScan(slapper::scanner::PortScanResults),
    EndpointScan(slapper::scanner::EndpointScanResults),
    Fingerprint(slapper::scanner::FingerprintResults),
    WafDetection(slapper::waf::WafDetectionResult),
    WafBypass {
        detection: slapper::waf::WafDetectionResult,
        bypasses: Vec<slapper::waf::BypassResult>,
    },
    WafStress(Vec<slapper::waf::BypassResult>),
    Pipeline(slapper::pipeline::PipelineReport),
    Fuzz(slapper::fuzzer::engine::FuzzSession),
    Recon(slapper::recon::FullReconResult),
    PacketCapture {
    ...
    #[cfg(feature = "advanced-hunting")]
    Hunt(slapper::hunt::HuntReport),
    #[cfg(feature = "headless-browser")]
    Browser(slapper::browser::BrowserReport),
    #[cfg(feature = "compliance")]
    Compliance(slapper::compliance::ComplianceReport),
    #[cfg(feature = "database")]
    Storage,
    #[cfg(feature = "database")]
    StorageListScans {
        scans: Vec<slapper::storage::models::StoredScan>,
    },
    #[cfg(feature = "database")]
    StorageListFindings {
        findings: Vec<slapper::findings::lifecycle::StoredFinding>,
    },
    #[cfg(feature = "external-integrations")]
    Integrations,
    #[cfg(feature = "external-integrations")]
    IntegrationsCreateIssue {
        issue: slapper::integrations::Issue,
    },
    #[cfg(feature = "external-integrations")]
    IntegrationsSearchIssues {
        issues: Vec<slapper::integrations::Issue>,
    },
    #[cfg(feature = "finding-workflow")]
    Workflow(slapper::workflow::WorkflowReport),
    #[cfg(feature = "vuln-management")]
    Vuln(slapper::vuln::VulnAssessment),
    #[cfg(feature = "wireless")]
    Wireless(slapper::wireless::WirelessScanResult),
    Error(String),
}
