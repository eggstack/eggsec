...
pub async fn run_graphql(
    ...
    use slapper::fuzzer::payloads::graphql::{
    ...
    tokio::time::timeout(op_timeout, async {
        ...
        let client = slapper::utils::get_shared_insecure_http_client();
...
pub async fn run_oauth(
    ...
    use slapper::fuzzer::payloads::oauth::{OAuthFuzzer, OAuthTestResult};
