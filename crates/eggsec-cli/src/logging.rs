...
/// Compatibility wrapper preserving the pre-Phase-A API and behavior
/// (console-enabled). The process host now prefers
/// `init_logging_with_console` with an explicit policy.
#[allow(dead_code)]
pub fn init_logging(
    format: LogFormat,
