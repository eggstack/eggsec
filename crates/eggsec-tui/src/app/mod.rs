...
impl App {
    ...
    fn apply_overlay_action(&mut self, action: UiAction) {
        match action {
            UiAction::Quit => {
    ...
    fn apply_nav_action(&mut self, action: UiAction) {
        match action {
            UiAction::FocusNext => {
    ...
    fn apply_input_action(&mut self, action: UiAction) {
        match action {
            UiAction::Enter => {
                self.handle_enter();
                self.needs_redraw = true;
    ...
    fn apply_clipboard_action(&mut self, action: UiAction) {
    ...
    fn apply_tab_action(&mut self, action: UiAction) {
    ...
    fn apply_confirm_action(&mut self, action: UiAction) {
        match action {
            UiAction::ResetCurrent => {
                if !self.has_active_task() {
                    if self.current_tab == Tab::History {
    ...
    fn apply_palette_action(&mut self, action: UiAction) {
    ...
    fn apply_quick_switch_action(&mut self, action: UiAction) {
    ...
    fn apply_overlay_content_action(&mut self, action: UiAction) {
        match action {
