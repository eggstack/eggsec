...
| Egress Decision | — | Phase E WS1 1.0.6 rejection (measured graphs, no edge) superseded 2026-09-22: narrow Eggress 1.0.8 `eggsec-web-proxy` proxy-engine edge (`eggress-outbound`/`eggress-uri`, pinned, no embed/routing/advanced); transport/eggfetch/policy/core stay Eggress-free | [egress_reuse_decision.md](egress_reuse_decision.md) |
