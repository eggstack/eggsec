...
| [`eggsec-python`](../crates/eggsec-python/) | Python bindings via PyO3/maturin. The scoped pre-1.0 stable core provides sync/async clients, canonical ten-operation dispatch, mandatory policy/audit decisions, typed payloads, versioned structured errors, and governed event backpressure. Consolidated recon, GraphQL/OAuth/authentication, daemon, NSE, database, and other domains remain provisional or experimental until they meet the common-engine graduation checklist. | [docs/python/](../docs/python/) |
