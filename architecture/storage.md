...
| `ScanModel` | `storage/models.rs` | Database model for scan records |
| `FindingModel` | `storage/models.rs` | Database model for finding records |
...
| `models.rs` | Database model structs (ScanModel, FindingModel, etc.) |
