...
| `eggsec-transport-eggfetch` | `HttpTransport` over published `eggfetch-core 0.1.5` (pinned direct + qualified proxy routes, H1/H2; production load-test backend) |
