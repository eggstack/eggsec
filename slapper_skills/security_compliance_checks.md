...
```bash
slapper compliance --target https://example.com
```

### Specific Check

```bash
slapper compliance --target https://example.com --check hsts,csp
```

### Full Report

```bash
slapper compliance --target https://example.com --format json --output compliance.json
```
