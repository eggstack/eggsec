...
description: Patterns for implementing security fixes in Eggsec
triggers:
  - security fix
  - vulnerability fix
...
This skill documents common security fix patterns implemented across the Eggsec codebase. Future agents should follow these patterns when implementing similar fixes.
...
**Files**: `eggsec-nse/src/libraries/imap.rs`
