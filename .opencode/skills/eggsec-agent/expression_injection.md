...
Eggsec supports expression language injection testing for various EL implementations used in Java-based frameworks. These vulnerabilities allow attackers to execute arbitrary code or access sensitive data.
...
eggsec fuzzer --target http://target.com/api --payload-type expression

# Java-based target
eggsec fuzzer --target http://target.com/springapp --payload-type expression
```
