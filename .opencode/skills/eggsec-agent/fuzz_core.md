...
This skill documents the core types and patterns used in the Eggsec fuzzer module.

## FuzzResult Struct

Location: `crates/eggsec/src/fuzzer/engine/types.rs`
...
Location: `crates/eggsec/src/fuzzer/filters.rs`
