...
The MCP (Model Context Protocol) server provides a JSON-RPC 2.0 API for AI agents to interact with Eggsec's security tools. It's designed for integration with LLM-powered assistants that need to execute security testing workflows.
...
eggsec serve --api-key your-key-here

# With scope restrictions
eggsec serve --api-key your-key-here --scope-file scope.toml

# With custom port
eggsec serve --port 8080
```
