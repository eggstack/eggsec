...
```bash
eggsec graphql --target https://api.example.com/graphql
```

### Introspection Query

```bash
eggsec graphql --target https://api.example.com/graphql --introspect
```

### Test Query Depth

```bash
eggsec graphql --target https://api.example.com/graphql --depth 10
```

### Mutation Testing

```bash
eggsec graphql --target https://api.example.com/graphql --test-mutations
```
