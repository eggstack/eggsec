...
Eggsec supports XPath injection testing for applications that use XML databases or process XML data. XPath injection can lead to unauthorized data access or authentication bypass.
...
eggsec fuzzer --target http://target.com/xml --payload-type xpath

# Target XML endpoint
eggsec fuzzer --target http://target.com/api/xml/parse --payload-type xpath
```
