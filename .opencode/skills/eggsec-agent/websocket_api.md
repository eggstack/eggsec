...
Eggsec's REST API includes WebSocket support for real-time updates and pub/sub functionality. The WebSocket endpoint enables clients to receive live notifications about scan progress, findings, and agent status.
...
# Or via eggsec CLI
eggsec rest-api --listen 127.0.0.1:8080 --ws-enable
```
...
ws.onopen = () => {
  console.log('Connected to Eggsec WebSocket');
  // Subscribe to topics
...
eggsec rest-api ws-topics

# Enable WebSocket logging
eggsec rest-api --listen 127.0.0.1:8080 --ws-log
```
