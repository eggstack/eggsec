...
```bash
eggsec pipeline --target https://example.com --profile quick
```

### Web Focus

```bash
eggsec pipeline --target https://example.com --profile web
```

### API Focus

```bash
eggsec pipeline --target https://example.com --profile api
```

### Deep Scan

```bash
eggsec pipeline --target https://example.com --profile deep
```
