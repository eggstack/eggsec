...
Testing patterns for the Eggsec TUI module.
...
cargo test --lib -p eggsec tui::components::input
cargo test --lib -p eggsec tui::tabs::mod
cargo test --lib -p eggsec tui::app::mod

# Run with output
cargo test --lib -p eggsec tui:: -- --nocapture
```
