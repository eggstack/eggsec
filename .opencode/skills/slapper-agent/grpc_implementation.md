...
description: gRPC server implementation status and patterns in Slapper
triggers:
  - gRPC
  - tonic
  - protobuf
...
This skill documents the gRPC implementation status in Slapper. The infrastructure is complete but the RPC methods are stubs.

## Current Status (2026-04-29)

**Infrastructure: COMPLETE**
- Proto definition: `tool/protocol/grpc.proto`
- Generated code: `generated/slapper.tool.v1.rs` (~1000 lines)
...
**Location**: `crates/slapper/src/tool/protocol/grpc.proto`
