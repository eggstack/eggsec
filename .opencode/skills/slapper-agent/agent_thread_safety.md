...
- `crates/slapper/src/agent/alerts.rs` - AlertRouter implementation
- `crates/slapper/src/agent/portfolio.rs` - TargetPortfolio implementation
- `crates/slapper/src/agent/memory.rs` - LongitudinalMemory implementation