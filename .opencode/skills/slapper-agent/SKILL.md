...
This skill directory contains specialized guides for the Slapper autonomous agent system. Each file covers a specific domain or capability.

## Available Skill Files

### Core Agent Capabilities
- `slapper-agent.md` - Main agent architecture and workflow
...
## Resources
- `crates/slapper/src/agent/AGENTS.override.md` - Agent module guidance
