...
HTTP load testing module workflows and patterns (Phase D core + 2026-09-17 corrective pass + 2026-09-19 0.1.7 adoption + 2026-09-22 0.2.0 adoption: mandatory execution scope, logical-URL + resolved-address Eggfetch backend).
...
and 4 local-resolution SOCKS5 tests. Treat the repeated 0.1.7-era loopback
