...
impl ScannerTool {
    ...
    pub fn fingerprint() -> Self {
        Self { mode: ScanMode::Fingerprint }
    }

    pub fn endpoints() -> Self {
        Self { mode: ScanMode::Endpoints }
    }
}
...
impl SecurityTool for ScannerTool {
    ...
    fn description(&self) -> &'static str {
        match self.mode {
            ...
            ScanMode::Fingerprint => "Identify services running on open ports by analyzing responses",
