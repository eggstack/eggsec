...
pub struct AdaptiveRateLimiter {
    ...
    last_rate_adjustment: Arc<Mutex<Instant>>,
...
impl AdaptiveRateLimiter {
    pub fn new(max_rate: u64, min_rate: u64, window_ms: u64) -> Self {
        Self {
            ...
            last_rate_adjustment: Arc::new(Mutex::new(Instant::now())),
...
impl RateLimiterTokenBucket {
    ...
    pub async fn acquire(&self, tokens: u64) -> bool {
        ...
        loop {
            ...
            if self.tokens.compare_exchange(current, new, Ordering::SeqCst, Ordering::SeqCst).is_ok() {
                return true;
            }
        }
    }
