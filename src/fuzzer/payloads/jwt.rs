                ...
                Ok(resp) => {
                    ...
                    if status == 200 || status == 201 {
                        results.push(JwtTestResult {
                            ...
                            description: format!("Token accepted by {} - status {}", endpoint, status),
                            severity: Severity::Critical,
                        });
                        ...
                        results.push(JwtTestResult {
                            ...
                            success: false,
                            token: format!("{} | Endpoint: {}", token, endpoint),
                            description: format!("Token rejected by {} - status {}", endpoint, status),
                        ...
                        results.push(JwtTestResult {
                            ...
                            success: false,
                            token: format!("{} | Endpoint: {}", token, endpoint),
                            description: format!("Server error on {} - possible algorithm confusion attack", endpoint),
                            severity: Severity::High,
                        });
                    }
                }
                ...
                Ok(resp) => {
                    ...
                    if status == 200 || status == 201 {
                        results.push(JwtTestResult {
                            ...
                            success: true,
                            token: token.clone(),
                            description: format!("None algorithm attack SUCCEEDED on {}!", endpoint),
                            severity: Severity::Critical,
                        });
                        break;
                    }
